...
// --- Konfigurasi Anda ---
const YOUR_DOMAIN = 'https://bokepterbarupijat.pages.dev'; // Ganti dengan domain Anda yang sebenarnya
const API_KEY_NAME = 'ab5cace0-7756-49a9-8822-d4ed409a8aea'; // Ganti dengan GUID Anda
